    ...
    <div className="min-h-full bg-gray-50">
      <div className="max-w-4xl mx-auto py-8 px-6">
        ...
        {contenidos.some(c => c.titulo.trim() !== '' || c.contenido.trim() !== '') && (
          <div className="mt-8 bg-yellow-50 border border-orange-ms rounded-lg p-6">
            <h3 className="font-medium text-brown-ms mb-3">👁️ Vista previa del contenido:</h3>
            <div className="bg-white p-4 rounded border border-orange-ms text-xs font-mono text-brown-ms max-h-40 overflow-y-auto">
